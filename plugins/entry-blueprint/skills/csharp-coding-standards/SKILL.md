...
description: C# 13 coding standards for the Enigmatry Entry Blueprint project — naming, formatting, nullability, and testing conventions. Use this when writing, reviewing, or refactoring any C# (.cs) file.
---
