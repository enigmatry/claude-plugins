...
description: TypeScript 5.x / ES2022 coding standards for the Enigmatry Entry Blueprint Angular project — naming, formatting, type system, async patterns, and architecture conventions. Use this when writing, reviewing, or refactoring any TypeScript (.ts) file.
---
